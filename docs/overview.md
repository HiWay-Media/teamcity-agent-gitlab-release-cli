# Panoramica dettagliata — teamcity-agent-gitlab-release-cli

> Questo file era `CLAUDE.md`. È stato spostato qui quando il repo ha adottato la convenzione di
> `devops_hiway`: `INTENT.md` = **perché**, `README.md` + questo file = **cosa**,
> `AGENTS.md` / `CLAUDE.md` = **come si lavora qui**.
